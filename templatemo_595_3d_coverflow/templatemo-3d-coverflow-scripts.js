...
// JavaScript Document
        ...
        const imageData = [
                        ...
                        {
                            title: "Esencia",
                            description: "Capturamos tu luz interior."
                        },
                        {
                            title: "Miradas",
                            description: "Historias que hablan sin palabras."
                        },
                        {
                            title: "Natural",
                            description: "Belleza auténtica y simple."
                        },
                        {
                            title: "Emoción",
                            description: "Momentos que llegan al alma."
                        },
                        {
                            title: "Confianza",
                            description: "Tu mejor versión, sin máscaras."
                        },
                        {
                            title: "Inspiración",
                            description: "Retratos que cuentan tu historia."
                        },
                        {
                            title: "Luz",
                            description: "Brillando desde adentro hacia afuera."
                        }
